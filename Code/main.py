...
def main(args: argparse.Namespace, activeloop: bool = True) -> None:
    ...
    # locpath = r"C:\Users\20214658\Desktop\Uni\Year 2\Q3\Data Challenge 1\DC1_group14\data"
    # train_dataset = ImageDataset(Path(locpath), Path(locpath))
    # test_dataset = ImageDataset(Path(locpath), Path(locpath))
